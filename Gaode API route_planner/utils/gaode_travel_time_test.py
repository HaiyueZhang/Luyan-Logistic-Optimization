...
def update_dataframes_with_api_results(dataframes, location_pairs):
...
def main_new_csv():
    ...
    input_filepath = f"{Path(__file__).parent}/../gaode/9.1-停车点-200m手动.csv"  # Update this path to your new CSV file
    output_filepath = f"{Path(__file__).parent}/../gaode/9.1-停车点-200m手动_nd.csv"  # Name of the output CSV file
    ...
    updated_dataframes = update_dataframes_with_api_results(dataframes, location_pairs)
